...
namespace Domain.Entities
{
    public class ExpensesReport : BaseEntity
    {
        ...
        public void SetDetails(string name, DateTime date, float utilityElectricity,
                          ...
                          float operationExpenses, float other, float totalExpenses, string comment, float balanceEndMonth)
        {
            Name = name;
            Date = date;
            ...
            Comment = comment;
            BalanceEndMonth = balanceEndMonth;
        }
    }
}
